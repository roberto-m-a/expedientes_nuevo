        ...
        if (result.isConfirmed) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    formEdit.reset();
                    flashMessage.value = 'Usuario editado correctamente';
    ...
    <Modal :show="abrirEdit">
        <div class="p-8 flex flex-col space-y-4">
            <div class="flex flex-row-reverse items-end justify-between overflow-hidden">
                <DangerButton @click="formEdit.reset();formEdit.clearErrors(); personal = null; abrirEdit = false;">X</DangerButton>
            </div>
            <p>
            ...
            <form @submit.prevent="editarPersonal">
                ...
                <TextInput id="Apellidos" type="text" class="mt-1 block w-full" v-model="formEdit.Apellidos" required />
                ...
                <div v-if="formEdit.Docente">
                    ...
                    <v-select type="text" id="gradoAcademico" label="nombreGradoAcademico"
                        ...
                        :filterable="true" v-model="formEdit.GradoAcademico" class="border-white" />
                ...
                <div v-if="formEdit.email != null">
                    <div class="mt-4" oncopy="return false" onpaste="return false">
                        ...
                        <TextInput id="email" type="email" class="mt-1 block w-full" v-model="formEdit.email" required
